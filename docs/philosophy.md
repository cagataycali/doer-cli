...
164 lines isn't a gimmick. It's a **contract**.

| you can…                          | because…                              |
| --------------------------------- | ------------------------------------- |
| read the whole source in a break  | it fits on four screens               |
...
Two hours later, `doer` was born. 164 lines of Python. One dep. No config. No state. Just `stdin → llm → stdout`.
